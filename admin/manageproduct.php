                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php
                                    ...
                                    product.productimage,product.productimagee,product.subcategory,subcategory.subcategory,subcategory.id as subcatid
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $r['productimagee'];?>" height="100px"></td>
                                                <td><?php echo $r['subcategory'];?> </td>
                                                <td>
                                                    <?php 
                                                        if (strlen($r['description']) > 100) {
                                                            echo substr($r['description'], 0, 100) . '... <a href="#" class="read-more">Read More</a><span class="more-content" style="display: none;">' . $r['description'] . '</span>';
                                                        } else {
                                                            echo $r['description'];
                                                        }
                                                    ?>
                                                ...
                                                <td>
                                                    <a href="editproduct.php?product_id=<?php echo $r['id'];?>"class="btn btn-success mr-2">Edit</a>
                                                    <a href="deleteproduct.php?product_id=<?php echo $r['id'];?>"class="btn btn-danger mr-2">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
...
<script>
    ...
    readMoreLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            link.innerText = (link.innerText === 'Read More') ? 'Read Less' : 'Read More';
        });
    });
</script>
