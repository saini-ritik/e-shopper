            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/1.png" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <span class="nav-item nav-link active">Welcome</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addsubcategory.php" class="dropdown-item">Add Sub-Category</a>
                            <a href="managesubcategory.php" class="dropdown-item">Manage Sub-category</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addslider.php" class="dropdown-item">Add Slider</a>
                            <a href="manageslider.php" class="dropdown-item">Manage Slider</a>
                        </div>
                    </div>
                </div>
            </nav>
